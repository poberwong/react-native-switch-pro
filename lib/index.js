...
export default class extends Component {
  ...
  componentWillReceiveProps (nextProps) {
    if (
      ...
      this.setSwitch(nextProps.value, true, () => null);
    }
  }
  ...
  _onPanResponderRelease = (evt, gestureState) => {
    ...
    if (toggleable) {
      if (onSyncPress) {
        this.setSwitch(!this.state.value, true, onSyncPress);
      } else {
  ...
  setSwitch = (toValue, result, callback = () => null) => { // "result" is result of task
