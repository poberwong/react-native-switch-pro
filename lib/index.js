...
export default class extends Component {
  static propTypes = {
    ...
    accessiblityLabel: PropTypes.string
  }
  ...
  render() {
    ...
    const _isDisabled = disabled ? 'Disabled. ' : '';
    const _accessibilityLabelFiller = value ? 'Switch, status: on' : 'Switch, status: off';
    ...
    return (
      <Animated.View
        ...
        accessible={true}
        accessibilityLabel={accessibilityLabel ? accessibilityLabel : _isDisabled + _accessibilityLabelFiller}
